    ...
    <div className="max-w-4xl mx-auto py-8 px-4">
      ...
      <form className="space-y-8">
        ...
        <div className="space-y-3">
          ...
          <Select>
            <SelectTrigger className="border-border text-myGray ">
              <SelectValue placeholder="Select a category" />
            </SelectTrigger>
            <SelectContent className="bg-primary border-border text-myGray">
              {categories.map((category) => (
                <SelectItem
                  key={category}
                  value={category}
                  className="hover:bg-myPurple/10 focus:bg-myPurple/20"
                >
                  {category}
                </SelectItem>
              ))}
